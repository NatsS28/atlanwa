      ...
      <div className='why_container'>
          ...
          <div className='contents'>
              <div className='headText_why'>
                  ...
                  {/* <h5 className='tail'>Once you place order on Atlanwa your
              ...
              <div className='headText'>
                  ...
                  {/* <h5 className='tail'>Your Data security & privacy is our priority.
              ...
              <div className='headText'>
                  ...
                  {/* <h5 className='tail'>Now enjoy the benefits of LG
